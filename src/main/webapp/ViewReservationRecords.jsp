...
<%@ page import="com.model.ReservationRecord" %>

<!DOCTYPE html>
<html>
<head>
    <title>View Reservation Records</title>
 <style>
        body,html {
            margin: 0; /* 清除默认外边距 */
            padding: 0; /* 清除默认内边距 */
        ...
        <main>
            <div class="user-info">
                ...
                <table border="1">
                    ...
                    <tbody>
                        <c:forEach var="record2" items="${reservationRecords}">
                            <tr>
                                <td>${record2.reservationId}</td>
                                <td>${record2.reservingClub}</td>
                                <td>${record2.venue}</td>
                                <td>${record2.reservationTimeStart}</td>
                                <td>${record2.reservationTimeEnd}</td>
                                <td>${record2.reservationStatus}</td>
                                <td>${record2.recordCreationTime}</td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
