...
<head>
    ...
    <body>
        ...
        <main>
            ...
            <div class="container">
                <div class="card">
                    <a onclick="window.location.href='ViewReimbursementRecords2.jsp'">查看报销申请表</a>
                </div>
                <div class="card">
                    <a onclick="window.location.href='ViewInvoiceAuthentication.jsp'">查看认证发票表</a>
                </div>
            </div>
            <div class="container">
                <div class="card">
                    <a onclick="window.location.href='InvoiceAuthentication.jsp'">认证发票</a>
                </div>
                <div class="card">
                    <a onclick="window.location.href='Reviewreimbursementform.jsp'">审核报销表</a>
                </div>
            </div>
        </main>
        <footer>
