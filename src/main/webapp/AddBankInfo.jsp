...
<head>
    ...
    <body>
        ...
        <div class="form" >
            ...
            <form class="login-form" action="AddBankInfoServlet" method="post">
                <h1 class="title">添加银行卡信息</h1>
                <div class="input-box">
                    <div class="input-item">
                        <input type="text" id="bankName" name="bankName" placeholder="请输入银行名称" required>
                    </div>
                    <div class="input-item">
                        <input type="text" id="accountNumber" name="accountNumber" placeholder="请输入银行账号" required>
                    </div>
                    <div class="input-item">
                        <input type="text" id="accountHolder" name="accountHolder" placeholder="请输入账户持有者姓名" required>
                    </div>
                    <div class="input-item">
                        <input type="text" id="branchName" name="branchName" placeholder="请输入分行名称" required>
                    </div>
                </div>
