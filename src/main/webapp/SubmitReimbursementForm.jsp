...
<head>
    ...
    <body>
        ...
        <header>
            ...
            <div class="menu">
                <p onclick="window.location.href='userDashboard.jsp'">HOME</p>
                <p>NEW</p>
        ...
        <main>
            <form  class="contact-form" action="SubmitReimbursementServlet" method="post" enctype="multipart/form-data">
                <div class="text-box">
                    <h1>提交报销申请</h1>
                </div>
                <div class="input-box">
                    <div class="input-item">
                        <input type="text" name="clubName" placeholder="请输入报销社团名称" required>
                    </div>
                    <div class="input-item2">
                        <textarea name="content" type="text" placeholder="请输入报销内容" required></textarea>
                    </div>
                    <div class="input-item">
                        <input type="number" name="amount" placeholder="请输入报销金额" step="0.01" required>
                    </div>
                    <div class="input-item4">
                        <input type="file" name="invoiceFile" id="invoiceFile" placeholder="请上传发票文件" required>
                        <label for="invoiceFile">请上传发票文件</label>
                    </div>
