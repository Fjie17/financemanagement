        ...
        <main>
            ...
            <table border="1">
                ...
                <tbody>
                	<tr>
                            <td>10001</td>
                            <td>zonghengshuxie</td>
                            <td>海报等费用</td>
                            <td>300.00</td>
                            <td>Approved by Finance</td>
                            <td>2024-12-27 21:50:00</td>
                            <td>2024-12-17 20:01:03</td>
                        </tr>
                    <c:forEach var="record1" items="${Records1}">
                        <tr>
                            <td>${record1.reimbursementId}</td>
                            <td>${record1.reimbursingClub}</td>
                            <td>${record1.reimbursementContent}</td>
                            <td>${record1.reimbursementAmount}</td>
                            <td>${record1.reimbursementStatus}</td>
                            <td>${record1.lastStatusUpdateTime}</td>
                            <td>${record1.recordCreationTime}</td>
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
