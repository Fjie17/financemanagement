...
<head>
    ...
    <body>
        ...
        <main>
            ...
            <div class="container">
                <div class="card">
                    <a onclick="window.location.href='ReservationForm.jsp'">提交场地预约申请</a>
                </div>
                <div class="card">
                    <a onclick="window.location.href='ViewReservationRecords'">查看场地预约记录</a>
                </div>
            </div>
            <div class="container">
                <div class="card">
                    <a href="SubmitReimbursementForm.jsp">提交报销申请</a>
                </div>
                <div class="card">
                    <a href="ViewReimbursementRecords.jsp">查看报销记录</a>
                </div>
            </div>
        </main>
        <footer>
